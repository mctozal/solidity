...
{
	Json ret = createAstNode(locationOf(_node), "YulBlock");
...
{
	Json ret = createAstNode(locationOf(_node), "YulLiteral");
	switch (_node.kind)
	{
...
Json AsmJsonConverter::operator()(Identifier const& _node) const
{
	...
	Json ret = createAstNode(locationOf(_node), "YulIdentifier");
	ret["name"] = _node.name.str();
	return ret;
}
...
Json AsmJsonConverter::operator()(Assignment const& _node) const
{
	...
	Json ret = createAstNode(locationOf(_node), "YulAssignment");
...
{
	Json ret = createAstNode(locationOf(_node), "YulFunctionCall");
...
{
	Json ret = createAstNode(locationOf(_node), "YulExpressionStatement");
...
{
	Json ret = createAstNode(locationOf(_node), "YulVariableDeclaration");
...
Json AsmJsonConverter::operator()(FunctionDefinition const& _node) const
{
	...
	Json ret = createAstNode(locationOf(_node), "YulFunctionDefinition");
	ret["name"] = _node.name.str();
...
Json AsmJsonConverter::operator()(If const& _node) const
{
	...
	Json ret = createAstNode(locationOf(_node), "YulIf");
...
Json AsmJsonConverter::operator()(Switch const& _node) const
{
	...
	Json ret = createAstNode(locationOf(_node), "YulSwitch");
	ret["expression"] = std::visit(*this, *_node.expression);
...
{
	Json ret = createAstNode(locationOf(_node), "YulCase");
...
Json AsmJsonConverter::operator()(ForLoop const& _node) const
{
	...
	Json ret = createAstNode(locationOf(_node), "YulForLoop");
